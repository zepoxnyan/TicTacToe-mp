...
public class VersusPlayer extends AppCompatActivity {
    ...
    public void makeMove(View v){
        ...
        TextView whosTurn = (TextView) findViewById(R.id.whosPlayin);
        if(Miza.getPlayer())
        {
            Miza.playRound(x,y,1);
            Miza.setPlayer(false);
            switchImage(x,y,1);
            whosTurn.setText(getResources().getString(R.string.p2turn));
        ...
        else
        {
            ...
            Miza.setPlayer(true);
            switchImage(x,y,2);
            whosTurn.setText(getResources().getString(R.string.p1turn));
        }
        endGame();
    }
